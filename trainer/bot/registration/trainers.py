...
@router.message(F.text == f'{training_registration_text}')
...
@router.message(Trainer.first_name)
...
@router.message(Trainer.average_calories)
...
@router.message(Trainer.sleep_time)
...
@router.message(Trainer.about_self)
...
@router.message(Trainer.password)
